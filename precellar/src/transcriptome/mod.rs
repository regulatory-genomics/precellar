...
impl SplicedRecord {
    ...
    /// 
    /// * `tolerance`: the maximum number of bases that can be misaligned at each junction.
    /// * `intergenic_trim_bases`: the number of bases to allow overhangs into intergenic regions.
    /// * `intronic_trim_bases`: the number of bases to allow overhangs into intronic regions.
    /// 
...
impl From<&RecordBuf> for SplicedRecord {
