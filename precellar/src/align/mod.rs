...
pub use aligners::{BurrowsWheelerAligner, StarAligner, AsIterator, Aligner, DummyAligner};
...
#[cfg(test)]
mod tests {
    use bwa_mem2::{AlignerOpts, FMIndex, PairedEndStats, BurrowsWheelerAligner};
